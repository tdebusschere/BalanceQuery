...
def main(now, current):
    parser = argparse.ArgumentParser(description="python DS_SQLGetDF_fail_schedule_v6.py --server=<serverid>")
    parser.add_argument('--server',nargs=1,type=str)
    try:        
        args = parser.parse_args()  
        
    except:
        sys.stdout.write("python DS_SQLGetDF_fail_schedule_v6.py --server=<serverid>")
        sys.exit()
